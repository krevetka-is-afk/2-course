...
```output
Find the max arg for factorial to not overflow 32-bit mword by CYCLE (press 1) or by RECURSION (press 2): 1
Max arg for factorial in CYCLE is: 11

-- program is finished running (0) --

Find the max arg for factorial to not overflow 32-bit mword by CYCLE (press 1) or by RECURSION (press 2): 2
